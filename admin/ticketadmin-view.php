<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){ ?>
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, aqui se muestran todos los Tickets de SOTEC Solutions los cuales podra eliminar, modificar e imprimir.</p>
            </div>
          </div>
        </div>
            <?php
