<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, en esta página se muestran todos los usuarios y administradores registrados en SOTEC Solutions, usted podra eliminarlos si lo desea.</p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 animated flip">
                    <h1 class="text-danger">Lo sentimos esta página es solamente para administradores de SOTEC Solutions</h1>
