        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-9 lead">
              <h2 class="text-info">Bienvenido a la configuración de cuenta SOTEC Solutions</h2>
              <p>Puedes <strong>actualizar los datos</strong> de tu cuenta ó puedes <strong>eliminar tu cuenta</strong> permanentemente si ya no deseas ser usuario de SOTEC Solutions</p>
            </div>
          </div><!--Fin row well-->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 animated flip">
                <h1 class="text-danger">Lo sentimos esta página es solamente para usuarios registrados en SOTEC Solutions</h1>
