...
$pdf->Image('../img/logo1.png',40,10,-300);
...
$pdf->Ln();
$pdf->Ln();
$pdf->Cell (0,5,utf8_decode('NIT: 6133682010'),0,1,'C');
$pdf->Cell (0,5,utf8_decode('Consultor:  Bladimir Iver Alejo Quispe'),0,1,'C');

$pdf->Ln();
$pdf->Cell (0,10,utf8_decode('Información de Ticket #'.utf8_decode($reg['serie'])),4,1,'C');
...
$pdf->cell(0,5,"SOTEC Solutions 2021",0,0,'C');
